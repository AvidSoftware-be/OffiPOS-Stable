...
Frieten_Famillie = Product(id=5, price=3.7, name='Famillie', group=1)
...
Koude_sauzen_Zigeuner_Provencaal = Product(id=18, price=0.7, name='Zigeuner/Provencaal', group=2)
Koude_sauzen_Tartare_Maison = Product(id=19, price=0.8, name='Tartare Maison', group=2)
Koude_sauzen_Andalouse = Product(id=20, price=0.8, name='Andalouse', group=2)
Koude_sauzen_Americain_Maison = Product(id=21, price=0.8, name='Americain Maison', group=2)
Koude_sauzen_Americain = Product(id=22, price=0.8, name='Americain', group=2)
Koude_sauzen_Samurai = Product(id=23, price=0.8, name='Samurai', group=2)
Koude_sauzen_Ardeense_saus = Product(id=24, price=0.8, name='Ardeense saus', group=2)
Koude_sauzen_Bearnaise = Product(id=25, price=0.8, name='Bearnaise', group=2)
Koude_sauzen_Brasil = Product(id=26, price=0.9, name='Brasil', group=2)
Koude_sauzen_Loempiasaus = Product(id=27, price=0.9, name='Loempiasaus', group=2)
Koude_sauzen_Joppiesaus = Product(id=28, price=0.9, name='Joppiesaus', group=2)
Koude_sauzen_Cocktail = Product(id=29, price=0.9, name='Cocktail', group=2)
Koude_sauzen_Pitta = Product(id=30, price=0.9, name='Pitta', group=2)
Koude_sauzen_Chilada_saus = Product(id=31, price=0.9, name='Chilada saus', group=2)
Koude_sauzen_Bicky_saus = Product(id=32, price=0.9, name='Bicky saus', group=2)
Koude_sauzen_Big_Giant_Hamburgersaus = Product(id=33, price=0.9, name='Big Giant Hamburgersaus', group=2)
...
Warme_sauzen_Vol_au_vent_saus = Product(id=38, price=1.4, name='Vol-au-vent saus', group=3)
...
Eigen_bereidingen_Balletjes_in_tomaat = Product(id=43, price=3.5, name='Balletjes in tomaat', group=4)
Eigen_bereidingen_Vol_au_vent = Product(id=44, price=3.5, name='Vol-au-vent', group=4)
...
Eigen_bereidingen_Saté_Klein_150gr = Product(id=48, price=2.5, name='Saté Klein 150gr', group=4)
Eigen_bereidingen_Saté_Groot_200gr = Product(id=49, price=3, name='Saté Groot 200gr', group=4)
Eigen_bereidingen_Kippebout_Saté = Product(id=50, price=2.5, name='Kippebout Saté', group=4)
...
Hamburgers_Chicken_Burger = Product(id=60, price=, name='Chicken Burger', group=5)
Hamburgers_Fish_Burger = Product(id=61, price=, name='Fish Burger', group=5)
Hamburgers_Giant_Baron_Burger = Product(id=62, price=, name='Giant Baron Burger', group=5)
Hamburgers_Red_Baron_Burger = Product(id=63, price=, name='Red Baron Burger', group=5)

Dranken_Blik_33cl = Product(id=66, price=1.5, name='Blik 33cl', group=6)
Dranken_Fles_0_5l = Product(id=67, price=2, name='Fles 0,5l', group=6)
Dranken_Water_Plat_Bruis = Product(id=68, price=1.1, name='Water Plat/Bruis', group=6)
...
Dranken_Twist_Drink = Product(id=72, price=1.6, name='Twist&Drink', group=6)
...
Snacks_Mammoet_plus_saus = Product(id=89, price=2.1, name='Mammoet + saus', group=7)
